...
function initTable() {
    var table = $('[data-ride="datatables"]').dataTable({
        ...
        "aoColumnDefs": [
            ...
            {
                "mRender": function (data, type, row) {
                    var url1 = "/tdmin/auth/roleedit/id/" + data;
                    //var url2 = "/tdmin/uuu/roledel/id/"+data;
            ...
            },
            {
                "mRender": function (data, type, row) {
                    ...
                    return '<div class="btn-group">\
                        <a class="btn btn-default btn-xs" type="button" href="/tdmin/auth/access/id/'+data+'">访问授权</a>\

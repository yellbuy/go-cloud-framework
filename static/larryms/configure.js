...
layui.define(function(exports){
	exports('configure',{
		...
		tabSession:false,//默认开启选项卡缓存记忆功能
		tabRefresh:false,//tab选项卡切换与导航重新点击是否刷新子页面默认关闭
		animations:true,//页面默认加载切换动画效果,直接影响全局动画效果，优先级高于主题设置
		grantUser:'qq_RusZX3PC',
 		grantKey:'43fTJjZ0sqR3XZ_PquCqaCjctRl'
	});
});
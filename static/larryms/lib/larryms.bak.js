...
function(e) {
    ...
    o = function() {
        this.version = "LarryMS 2.0.9.01_rc",
        this.sysName = "",
        this.tit = [this.sysName + "提示", this.sysName + "错误提示", this.sysName + "参数配置错误提示", this.sysName + "数据源配置错误", "关闭失败提示", "操作成功", "操作失败", this.sysName + " Ajax 调试信息控制台"],
        this.config = {
            plusDir: "/common/plus/",
            jqDefined: undefined,
            jqUrl: undefined
    ...
    o.prototype.grantCheck = function(e, r, t) {
        var n = d(e, r, t);
        if (n) {
            return true
        } else {
    ...
    o.prototype.deviceType = function() {
        var e = this;
        if (k.android || k.ios || n.width() <= 768) {
            return {
                devices: "mobile",
                browser: e.typeFn.browserType()
            }
        } else if (n.width() > 768 && n.width() < 1e3) {
            return {
                devices: "pad",
                browser: e.typeFn.browserType()
            }
    ...
    o.prototype.placeholder = function() {
        var e = this,
        r = "";
        x("input.larryms-input,input.larry-input,textarea.larry-textarea,.larryms-textarea,input.larry-input[type='text'],input.larry-input[type='password']").on("focus",
        function() {
            r = x(this).attr("placeholder");
            x(this).attr("placeholder", "")
        });
        x("input.larryms-input,input.larry-input,textarea.larry-textarea,.larryms-textarea,input.larry-input[type='text'],input.larry-input[type='password']").on("blur",
        function() {
    ...
    o.prototype.fontset = function(e) {
        var r = this;
        x.extend(true, r.fonts, e);
        var t = r.getPath("layui.js").commonPath;
        if (x(".fa").length > 0) {
            var n = t + "larry/font/fa/font-awesome.min.css";
            layui.link(n)
        }
        if (r.fonts.online) {
            ...
            if (x(".larry-icon").length > 0) {
                var a = t + "larry/font/larryicon/larryicon.css";
                layui.link(a)
            }
        }
    };
    o.prototype.plugin = function(e, r, t) {
        if (r === undefined) {
            r = function() {
                return true
            }
        ...
        if (x.isPlainObject(t)) {
            ...
            if (t.plusDir == undefined) {
                t.plusDir = m("layui.js").url
            }
            if (t.jqUrl == undefined) {
                t.jqUrl = m("layui.js").url
            }
            this.set(t)
        ...
        if (typeof e == "string") {
            ...
            if (!this.config.jqDefined) {
                ...
                p = y.getElementsByTagName("head")[0];
    ...
    o.prototype.fullSize = function() {
        var e = this,
        r = e.config,
        t = r.height,
        n
    };
    o.prototype.message = function(e, t, r, n) {
        var a = this,
        e = e || "default",
        t = t || "other",
        i = r || "larry-xiaolian1",
    ...
    o.prototype.htmlRender = function(e, r) {
    ...
    o.prototype.sysExportConsole = function(e, r, t, n) {
        var a = this,
        n = n || a.sysName;
    ...
    o.prototype.eventsCheck = function(e) {
        var r = {
            eventName: "",
            filter: ""
        };
    ...
    o.prototype.elemCheck = function(e, r) {
        var t, n = this;
        if (r == "top_menu") {
            if (e === undefined) {
                t = "undefined";
    ...
    o.prototype.msg = function(e, r, t) {
        return l.msg(e, r, t)
    };
    o.prototype.error = function(e, r, t, n) {
        var a = this,
        e = e || false,
        n = n || 0,
        r = r || a.sysName;
    ...
    o.prototype.success = function(e, r, t, n) {
        var a = this,
        e = e || true,
        n = n || 0,
        r = r || a.sysName;
    ...
    o.prototype.tips = function(e, r, t) {
        return l.tips(e, r, t)
    };
    o.prototype.closeAll = function(e) {
        return l.closeAll(e)
    };
    o.prototype.alert = function(e, r) {
        l.alert(e, {
            end: r,
            scrollbar: false
        })
    };
    o.prototype.prompt = function(e, r) {
        return l.prompt(e, r)
    };
    o.prototype.photos = function(e, r, t) {
    ...
    o.prototype.confirm = function(e, r, t, n) {
        var a = this,
        i = {
            icon: 3,
            skin: "larry-debug",
    ...
    o.prototype.escape = function(e) {
        return String(e || "").replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;")
    };
    o.prototype.escape2Html = function(e) {
        var t = {
            lt: "<",
            gt: ">",
            nbsp: " ",
    ...
    o.prototype.content = function(e, t) {
        var a = this;
        var r = function(e) {
    ...
    o.prototype.CheckIsColor = function(e) {
    ...
    o.prototype.isCardID = function(e) {
        var r = this;
    ...
    o.prototype.isVerify = function(e, r) {
        switch (r) {
        case "phone":
    ...
    o.prototype.triggerVerify = function(e, r) {};
    o.prototype.stringFn = {
        trim: function(e, r) {
            r = r || 1;
            switch (r) {
            case 1:
    ...
    o.prototype.configFilter = function(e, r) {
        var t = {};
        for (var n in e) {
    ...
    o.prototype.cleanCached = {
        clearAll: function() {
            p()
        }
    };
    o.prototype.getDay = function(e) {
        var r, t = e.getDay();
        switch (t) {
        case 1:
            r = 1;
    ...
    o.prototype.panel = function() {
        ...
        function() {
            if (x(this).hasClass("larry-unfold1")) {
                ...
                x(this).parent(".larry-panel-header").siblings(".larry-panel-body").slideToggle(300)
            } else {
        ...
        function() {
            x(this).parents(".larry-panel").parent().fadeOut(300)
        })
    };
    o.prototype.utf16to8 = function(e) {
        var r, t, n, a;
        r = "";
        n = e.length;
        for (t = 0; t < n; t++) {
    ...
    o.prototype.notice = function(e, r, t, n) {
        var a = this;
        var i = {
            title: false,
        ...
        o = {
            ...
            transition: {
                animin: "pt-page-moveFromRightFade",
                animout: "pt-page-fade"
            },
        ...
        function v(e) {
            ...
            if (o.type == 1) {
                ...
                x(e).children("#larryms-msg").append(m);
                var r = "#" + x(m).attr("id");
                if (x(e).find(r).children(".larryms-msg-close").hasClass("layui-hide")) {
                    setTimeout(function() {
                        x(e).find(r).removeClass(o.transition.animin).addClass(o.transition.animout);
                        setTimeout(function() {
                            x(e).find(r).remove()
                        },
                        i.delay)
    ...
    o.prototype.noticeAllClose = function() {
    ...
    o.prototype.createAudio = function(e) {
        var r = this;
    ...
    function d(e, r, t) {
        e = larryms.stringFn.trim(e);
        t = larryms.stringFn.trim(t);
        r = larryms.stringFn.trim(r);
